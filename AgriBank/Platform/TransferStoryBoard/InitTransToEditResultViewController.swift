//
//  InitTransToEditResultViewController.swift
//  AgriBank
//
...
class InitTransToEditResultViewController: BaseViewController {
    ...
    @IBAction func clickConfirmBtn(_ sender: Any) {
        enterFeatureByID(.FeatureID_InitTransToNoQry, false)
    }
}
