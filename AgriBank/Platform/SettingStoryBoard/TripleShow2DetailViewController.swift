//
//  TripleShow2DetailViewController.swift
//  AgriBank
//
//  Created by 數位資訊部 on 2020/6/24.
//  Copyright © 2020 Systex. All rights reserved.
//

import UIKit
let show2GoToTripleView_Segue = "show2GoToTripleView"
let show2GoToTripleResult_Segue = "show2GoToTripleResult"
class TripleShow2DetailViewController:BaseViewController ,UITableViewDataSource, UITableViewDelegate {
 ...
 //更改領取方式
    @IBAction func BtnChangeRewardCode(_ sender: Any) {
        transactionId = tempTransactionId
         performSegue(withIdentifier: show2GoToTripleView_Segue, sender: nil)
        isBack = "ChangeReward"
    }
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        //取消綁定
        if segue.identifier == show2GoToTripleResult_Segue
           {
               let controller = segue.destination as! TripleResultViewController
               var list = [[String:String]]()
            if let BINDNO =  TripleCodeInfo[("原綁定序號")]{
                ...
                case "QR1004":
                   if let returnCode = response.object(forKey: ReturnCode_Key) as? String, returnCode != ReturnCode_Success {
                   ...
                   else
                    {
                       ...
                       performSegue(withIdentifier: show2GoToTripleResult_Segue, sender: nil)
                           }
