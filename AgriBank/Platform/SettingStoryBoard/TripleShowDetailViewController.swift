//
//  TripleShowDetailViewController.swift
//  AgriBank
//
...
import UIKit
let showGoToTripleView_Segue = "showGoToTripleView"
class TripleShowDetailViewController: BaseViewController , UITableViewDataSource, UITableViewDelegate  {
    ...
    @IBAction func BtnShowRefundCode(_ sender: Any) {
        transactionId = tempTransactionId
         performSegue(withIdentifier: showGoToTripleView_Segue, sender: nil)
    }
