//
//  CardlessSetupAcceptRulesViewController.swift
//  AgriBank
//
//  Created by ABOT on 2022/9/13.
...
class CardlessSetupAcceptRulesViewController: BaseViewController {
...
//        let version: String = AuthorizationManage.manage.getGoldAcception().Version
        ...
        postRequest("Comm/COMM0118", "COMM0118", AuthorizationManage.manage.converInputToHttpBody(["WorkCode":"16002","Operate":"termsConfirm","TransactionId":transactionId,"Version":version,"uid": AgriBank_DeviceID], true), AuthorizationManage.manage.getHttpHead(true))
    }
