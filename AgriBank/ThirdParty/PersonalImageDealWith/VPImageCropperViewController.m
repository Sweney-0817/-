...
- (void)initView {
    ...
    self.ratioView.layer.cornerRadius = self.ratioView.frame.size.width / 2.0;
...
- (void)initControlBtn {
    ...
    UILabel* lbTitle = [[UILabel alloc]initWithFrame:CGRectMake(0, 50.0f, self.view.frame.size.width, 50)];
    lbTitle.autoresizingMask = UIViewAutoresizingFlexibleWidth | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleRightMargin |UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin;
    lbTitle.textAlignment = NSTextAlignmentCenter;
    lbTitle.lineBreakMode = NSLineBreakByWordWrapping;
    lbTitle.font = [UIFont boldSystemFontOfSize:18.0f];
...
- (void)overlayClipping
{
    ...
    */
    ...
    CGPathAddRect(path, nil, self.overlayView.frame);
    CGPathAddEllipseInRect(path, nil, self.ratioView.frame);
